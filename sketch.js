...
var END = 0;
var gameState = PLAY;
var lives,livesh,livesh1,lives2;
var mario;
var  arr=[];
var ground, invisibleGround, groundImage,coing;

var powerg,mariostop,heart;
...
function setup() {
 ...
 //creating groupos
  ...
  livesh=createSprite(550,50,20,20);
  livesh.addImage(heart);
  livesh.scale=0.05;
  livesh1=createSprite(600,50,20,20);
  livesh1.addImage(heart);
  livesh1.scale=0.05;
  livesh2=createSprite(650,50,20,20);
  livesh2.addImage(heart);
  livesh2.scale=0.05;
}
...
console.log(mouseY);
  ...
  fill("yellow");
  textSize(20);
  text("Lives left:",420,60);
  }
  textSize(35)
  fill("black");
  text("Score: "+ score, 720,60);
